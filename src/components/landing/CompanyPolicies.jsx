        ...
        <div className="flex flex-col md:flex-row w-full min-[736px]:w-90 md:w-3/4 gap-8 md:gap-10 lg:gap-16">
          <Card>
            <Card.Body className="flex items-center gap-4">
              ...
              <Button
                className={
                  "flex justify-center items-center w-full md:w-3/4 border border-gray hover:bg-accent hover:border-transparent hover:text-white gap-4 my-2 transition delay-50 group"
                }
              >
